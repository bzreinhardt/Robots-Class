function [] = TestFunHW1(TestVals, maxVel, robotRad)
...
%   robotRad - Radius of the robot (m)
...
for i = 1:size(TestVals,1)
    ...
    %   check - 2/5
    [cmdV,cmdW] = feedbackLin(velX,velY,Theta,Epsilon);
    ...
    %   cmdV - the desired forward velocity of the robot
    %   cmdW - the desired angular velocity of the robot
    [cmdV,cmdW] = limitCmds(cmdV, cmdW, maxVel, robotRad);
